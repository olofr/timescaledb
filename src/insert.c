...
insert_main_table_trigger(PG_FUNCTION_ARGS)
{
	...
	/* add 1 to the number of processed tuples in the commandTag. Without this tuples that return 
	 * NULL in before triggers are not counted. */
	add_number_tuples_processed(1);
